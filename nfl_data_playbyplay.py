...
def parse_into_game_data():
	...
	for k, v in df2012.groupby('gameid'):
		...
		if home == _scoredb['off']:
			...
			# print win_loss['home_score'], _scoredb['offscore']
		...
		if win_loss['teamwin'] == 1:
			...
			elif win_loss['home'] == win_loss['def']:
				win_loss['home_team_win'] = 1
...
all_games_df[all_games_df['home_score'] > all_games_df['away_score']].shape[0]
